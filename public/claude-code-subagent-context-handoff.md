---
title: Claude Code でサブエージェントの結果を「親のコンテキストを汚さず」受け渡す — 結論＋住所だけ返させる実践
tags:
  - 生成AI
  - LLM
  - プロンプトエンジニアリング
...
> これは[「報告を構造化して並列集計する」](https://qiita.com/StreamSolty/items/bd039b8004d9420dd96d)[「独立した検証エージェントで裏取りする」](https://qiita.com/StreamSolty/items/0fda2216380f4b0391a8)話の続編です。前回までは**子から受け取った中身**の扱いでしたが、今回は**子に何を返させ、親に何を残さないか**という受け渡しの設計です。
