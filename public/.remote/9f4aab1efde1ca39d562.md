...
tags:
  ...
  - ClaudeCode
private: false
updated_at: '2026-06-09T17:04:01+09:00'
...
## あなたの「ヒヤリ」を1行で教えてください

最後にひとつ、率直に聞かせてください。

Claude Codeを使っていて、**「これ、自動でブロック／通知できたら事故らずに済むのに」**と思った手作業やヒヤリは何ですか？

例:
・コスト超過に後から気づく
・うっかり本番ファイルや設定を触りそうになる
・コミット前のチェックを忘れる

コメント欄か X（[@k___n___t_1125](https://x.com/k___n___t_1125)）に**1行**もらえると、実際のHook設定例にして記事で答えます。「自分のこのケース、Hookで防げる？」という相談も歓迎です。

逆に「Hooksは自分には要らないな」という方は、その理由を一言もらえると同じくらい参考になります。
