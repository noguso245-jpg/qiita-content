...
コマンド化と相性のいいCLAUDE.md設計やコミット戦略などの関連スキルは、無料リポで配布しています（記事末にリンク）。
...
スラッシュコマンドの土台になるCLAUDE.md設計や、コマンド化したくなる定番ワークフロー（計画ファースト開発・コミット戦略など）を、そのまま使えるスキルとして無料リポで公開しています。
